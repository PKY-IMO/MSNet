...
from .backbone import test_1_pre,test_2_pre,test_3_pre,test_4_end,CNN4_b,CNN1_a,CNN3_c,CNN2_d,osnet_x1_0,OSNet_1
...
class M123_o(nn.Module):
    def __init__(self, num_classes, num_stripes=4, local_conv_out_channels=32, feats=256 ,erase=0, loss={'softmax'}, avg=False, **kwargs):
        ...
        model_ft_d = osnet_x1_0(pretrained=True)
        cnnd = OSNet_1(num_classes=1000,**kwargs)
        # print(cnnd)
