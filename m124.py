...
class M124(nn.Module):
    def __init__(self, num_classes, num_stripes=4, local_conv_out_channels=32, feats=256 ,erase=0, loss={'softmax'}, avg=False, **kwargs):
        ...
        self.avgpool_p8 = pool2d(kernel_size=(6, 8))
    ...
    def forward(self, x):
        ...
        f1 = [f1_p1, f2_p1,f2_p2,f8_p1, f8_p2, f8_p3, f8_p4]
        l1 = [l1_p1, l2_p1,l2_p2,l8_p1, l8_p2, l8_p3, l8_p4]
        predict = torch.cat([f1_p1, f2_p1,f2_p2,f8_p1, f8_p2, f8_p3, f8_p4], dim=1)
