...
class MM(nn.Module):
    def __init__(self, num_classes, num_stripes=4, local_conv_out_channels=256, feats=512 ,erase=0, loss={'softmax'}, avg=False, **kwargs):
        ...
        model_ft_d = test_2_end(pretrained=True)
        ...
        print('1ceshi')
        self.num_ftrs = list(cnna.conv4)[-1].conv1.in_channels
        ...
        self.avgpool_p8 = pool2d(kernel_size=(3, 8))
    ...
    def forward(self, x):
        ...
        print('特征图已得到')
        assert feats_d.size(2) == 24
        assert feats_d.size(-1) == 8
        assert feats_d.size(2) % self.num_stripes == 0
        
        print('校验通过')
        p1 = self.avgpool_p1(feats_a)


        p2 = self.avgpool_p2(feats_b)
        z0_p2 = p2[:, :, 0:1, :]
        z1_p2 = p2[:, :, 1:2, :]

        p4 = self.avgpool_p3(feats_c)
        z0_p4 = p4[:, :, 0:1, :]
        z1_p4 = p4[:, :, 1:2, :]
        z2_p4 = p4[:, :, 2:3, :]
        z3_p4 = p4[:, :, 3:4, :]

        p8 = self.avgpool_p4(feats_d)
        z0_p8 = p8[:, :, 0:1, :]
        z1_p8 = p8[:, :, 1:2, :]
        z2_p8 = p8[:, :, 2:3, :]
        z3_p8 = p8[:, :, 3:4, :]
        ...
        predict = torch.cat([f1_p1, f2_p1, f2_p2, f4_p1, f4_p2, f4_p3, f4_p4, f8_p1,f8_p2,f8_p3,f8_p4,f8_p5,f8_p6,f8_p7,f8_p8], dim=1)

        return predict, l1_p1, l2_p1, l2_p2, l4_p1, l4_p2, l4_p3, l4_p4, l8_p1,l8_p2,l8_p3,l8_p4,l8_p5,l8_p6,l8_p7,l8_p8
